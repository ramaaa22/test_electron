    ...
    export default {
        ...
        methods: {
            ...
            actualizeServicesAvailables(){
                ...
                let arr_services = this.services.map(service => service.name);
                let new_array= arr_services.filter(service => arr_accesses.indexOf(service) == -1);
            ...
            async getPermissions(service) {
                ...
                //this.accesses.push(this.services[pos2]);
